...
public class GlobalExceptionHandler {
   ...
   *
   * @param exception The PaymentNotFoundException thrown when a client is not found.
  ...
  public ResponseEntity<ApiError> handlePaymentNotFoundException(PaymentNotFoundException exception,
    ...
    return new ResponseEntity<>(
        new ApiError(LocalDateTime.now(), HttpStatus.NOT_FOUND.value(), "Payment not found",
